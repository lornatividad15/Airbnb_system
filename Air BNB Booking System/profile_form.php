...
<?php if (isset($_SESSION['profile_error'])): ?>
  showModal(`<?php echo addslashes($_SESSION['profile_error']); ?>`, 'ok-only');
  <?php unset($_SESSION['profile_error']); ?>
<?php elseif (isset($_SESSION['profile_message'])): ?>
  showModal(`<?php echo addslashes($_SESSION['profile_message']); ?>`, 'ok-only');
